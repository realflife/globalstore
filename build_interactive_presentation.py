    ...
    <style>
        ...
        * {{
        ...
        @media (max-width: 1024px) {{
            ...
            .data-flow-pipeline .pulse-arrow {{
...
<body>
    ...
    <main class="main-content">
        ...
        <div class="presentation-container" id="presentationContainer">
                ...
                <div class="grid-3" style="row-gap: 1.5rem;">
                    ...
                    <div class="card" style="border-top: 4px solid var(--gold); padding: 1.25rem;">
                        ...
                        <div style="font-size: 0.8rem; margin-bottom: 0.6rem;">
                            <div style="color: #fff; font-weight: 700;">🌐 ระดับกลุ่ม Market (ภูมิภาค):</div>
                            <div style="color: var(--gold-light); font-weight: 800; font-size: 0.95rem; margin-top: 0.15rem;">Big 3: APAC, EU & US + 💎 Canada</div>
                            <div style="color: var(--text-secondary); margin-bottom: 0.4rem;">• <strong>APAC, EU, US</strong> คือฐานรากสร้างกำไร 80% ($1.09M)<br>• <strong>Canada</strong> คือเพชรในตม Margin สูงสุดในโลก <strong>+26.6%</strong> (Win Rate 98.2% เพราะไม่ลดราคาเลย!)</div>
                            <div style="color: #fff; font-weight: 700;">🏆 ตลาดทองคำ (Country Level):</div>
                            <div style="color: var(--text-secondary);">USA, China & India (จีน&อินเดีย Margin สูง 22%)</div>
                        </div>
                        <div style="background: rgba(244, 63, 94, 0.1); padding: 0.5rem; border-radius: 8px; font-size: 0.75rem;">
                            <span style="color: #fda4af; font-weight: 700;">🛑 หลุมดำ:</span> <strong>EMEA</strong> (Margin ต่ำสุด 5.4%) และประเทศลดแหลก: <strong>Turkey (-$98K)</strong>, <strong>Nigeria (-$80K)</strong>, <strong>Netherlands (-$41K)</strong>
                        </div>
                    </div>
            ...
            <!-- SLIDE 7: 4 Immediate Actionable Growth & Defense Policies (Visual Cards) -->
            <div class="slide" id="slide-7">
                <div class="slide-header">
                    ...
                    <h2 class="slide-title">4 นโยบายสั่งการ: ปิดจุดรั่วไหลและกระตุ้นยอดขายเชิงรุก (Growth & Defense)</h2>
                    <p class="slide-subtitle">ข้อเสนอแนะเชิงกลยุทธ์ที่สามารถสั่งการผ่านระบบ BI ได้ทันที ทั้งการหยุดขาดทุน (Stop Loss -$500K) และการรุกเพิ่มรายได้ใหม่ (Revenue Boost +$2.1M)</p>
                </div>

                <div class="grid-2" style="row-gap: 1.25rem; column-gap: 1.5rem;">
                    <div class="card" style="border-left: 4px solid var(--gold); padding: 1.25rem;">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.4rem;">
                            <span style="background: var(--gold); color: #000; font-weight: 800; padding: 0.2rem 0.65rem; border-radius: 6px; font-size: 0.78rem;">นโยบายที่ 1 (ตั้งรับ)</span>
                            <span class="badge-pill badge-gold" style="font-size: 0.75rem;">+$500K+/Year</span>
                        </div>
                        <h3 class="card-title" style="color: var(--gold-light); font-size: 1.05rem; margin-bottom: 0.4rem;">ตั้งเพดานส่วนลดเหล็กไม่เกิน 20%</h3>
                        <p class="card-text" style="font-size: 0.82rem; margin-bottom: 0.5rem;">
                        ...
                        <div style="font-size: 0.75rem; color: #fde047; background: rgba(245, 158, 11, 0.1); padding: 0.45rem; border-radius: 6px; font-weight: 700;">
                    ...
                    <div class="card" style="border-left: 4px solid var(--rose); padding: 1.25rem;">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.4rem;">
                            <span style="background: var(--rose); color: #fff; font-weight: 800; padding: 0.2rem 0.65rem; border-radius: 6px; font-size: 0.78rem;">นโยบายที่ 2 (ปรับทัพ)</span>
                            <span class="badge-pill badge-danger" style="font-size: 0.75rem;">Stop Loss: -$64K</span>
                        </div>
                        <h3 class="card-title" style="color: #fda4af; font-size: 1.05rem; margin-bottom: 0.4rem;">ปฏิรูปโมเดลขายโต๊ะ (Bundle Selling)</h3>
                        <p class="card-text" style="font-size: 0.82rem; margin-bottom: 0.5rem;">
                        ...
                        <div style="font-size: 0.75rem; color: #fda4af; background: rgba(244, 63, 94, 0.1); padding: 0.45rem; border-radius: 6px; font-weight: 700;">
                    ...
                    <div class="card" style="border-left: 4px solid var(--emerald); padding: 1.25rem;">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.4rem;">
                            <span style="background: var(--emerald); color: #fff; font-weight: 800; padding: 0.2rem 0.65rem; border-radius: 6px; font-size: 0.78rem;">นโยบายที่ 3 (ควบคุม)</span>
                            <span class="badge-pill badge-success" style="font-size: 0.75rem;">Save: +$236K/Year</span>
                        </div>
                        <h3 class="card-title" style="color: var(--emerald-light); font-size: 1.05rem; margin-bottom: 0.4rem;">คุมเข้มส่งด่วน Express & ข้ามทวีป</h3>
                        <p class="card-text" style="font-size: 0.82rem; margin-bottom: 0.5rem;">
                        ...
                        <div style="font-size: 0.75rem; color: var(--emerald-light); background: rgba(16, 185, 129, 0.1); padding: 0.45rem; border-radius: 6px; font-weight: 700;">
                            🚚 ผลลัพธ์: ระงับจุดรั่วไหลจาก 634 ออเดอร์อันตราย เซฟเงินคืนได้ $236,784 ต่อปี!
                        </div>
                    </div>

                    <div class="card" style="border-left: 4px solid #38bdf8; padding: 1.25rem; background: rgba(56, 189, 248, 0.03);">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.4rem;">
                            <span style="background: #38bdf8; color: #000; font-weight: 800; padding: 0.2rem 0.65rem; border-radius: 6px; font-size: 0.78rem;">🚀 นโยบายที่ 4 (เชิงรุก)</span>
                            <span class="badge-pill" style="background: rgba(56, 189, 248, 0.2); color: #38bdf8; border: 1px solid #38bdf8; font-size: 0.75rem;">Revenue: +$2.1M</span>
                        </div>
                        <h3 class="card-title" style="color: #38bdf8; font-size: 1.05rem; margin-bottom: 0.4rem;">กระตุ้นขายพ่วงข้ามหมวด (Cross-Selling Multiplier)</h3>
                        <p class="card-text" style="font-size: 0.82rem; margin-bottom: 0.5rem;">
                            ใช้ระบบ Recommendation เสนอขายสินค้า <strong>Winners (Copiers & Accessories)</strong> พ่วงในบิลเดียว เพราะข้อมูลสถิติมัดตัวว่า <strong>บิลซื้อพ่วงข้ามหมวด (Multi-Category)</strong> สร้างยอดขายเฉลี่ยต่อบิลพุ่งเป็น <strong>$903.28 (โต 3.2 เท่า!)</strong> และทำกำไรต่อบิลโต 3 เท่า ($102) เทียบกับบิลหมวดเดียว ($278)
                        </p>
                        <div style="font-size: 0.75rem; color: #38bdf8; background: rgba(56, 189, 248, 0.1); padding: 0.45rem; border-radius: 6px; font-weight: 700;">
                            📈 ผลลัพธ์: เพิ่มขนาดตะกร้า (Basket Size) ในไตรมาส 4 (High Season) สร้างรายได้ใหม่โดยไม่ต้องหั่นส่วนลด!
                        </div>
                    </div>
                </div>

                <div style="margin-top: 1.5rem; text-align: center;">
                    <button class="btn btn-gold" style="margin: 0 auto; padding: 0.8rem 2.25rem; font-size: 1rem;" onclick="switchMode('dash')">
                        <i class="fa-solid fa-chart-pie"></i>
                        <span>เปิดระบบ Interactive BI Dashboard เพื่อทดสอบกรองข้อมูลจริง</span>
                    </button>
                </div>

                <div class="speaking-notes" style="margin-top: 1.25rem;">
                    <div class="notes-header"><i class="fa-solid fa-microphone-lines"></i> สคริปต์พูด (Slide 7: 4 นโยบายรุกและรับ)</div>
                    <div class="notes-text">"นี่คือ 4 นโยบายสั่งการที่ครอบคลุมทั้ง 'การรับ (Defensive Stop-Loss)' และ 'การรุก (Offensive Growth)' ครับ 1. กฎเหล็กส่วนลด 20% ห้ามลดเกินนี้เด็ดขาด 2. ปฏิรูปโมเดลขายโต๊ะเป็น Bundle 3. คุมเข้มค่าส่ง Express ข้ามประเทศ และ 4. นโยบายเชิงรุก: กระตุ้นการขายพ่วงข้ามหมวด (Cross-Selling Multiplier) โดยอัดโปรโมชันคู่สินค้า Winners เพราะข้อมูลชี้ชัดว่าออเดอร์ซื้อพ่วงข้ามหมวดสร้างยอดขายต่อบิลสูงถึง $903 (โต 3.2 เท่า) และทำกำไรต่อบิลโตถึง 3 เท่า! ขอเชิญทุกท่านกดสลับโหมดไปที่ Interactive BI Dashboard บนจอ เพื่อดูข้อมูลจริงที่สนับสนุนทั้ง 4 นโยบายนี้ด้วยกันครับ!"</div>
                </div>
            </div>
        ...
        <div class="dashboard-container" id="dashboardContainer">
            ...
            <div class="filter-toolbar">
                ...
                <div style="display: flex; gap: 0.5rem; flex-wrap: wrap;">
                    ...
                    <button class="quick-btn" id="btnQuickMap" onclick="scrollToMap()" style="color: #38bdf8;"><i class="fa-solid fa-earth-americas"></i> 🗺️ แผนที่กำไร-ขาดทุนโลก</button>
                </div>
            </div>
            ...
            <!-- GLOBAL PROFIT & LOSS INTERACTIVE MAP DASHBOARD -->
            <div class="card" id="globalProfitMapSection" style="margin-bottom: 1.5rem; padding: 1.25rem; background: radial-gradient(circle at top, rgba(15, 23, 42, 0.98), rgba(9, 14, 23, 0.98)); border: 1px solid rgba(56, 189, 248, 0.35); border-radius: 14px; box-shadow: 0 10px 30px rgba(0,0,0,0.5);">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem; flex-wrap: wrap; gap: 0.75rem; border-bottom: 1px solid rgba(255,255,255,0.1); padding-bottom: 0.75rem;">
                    <div>
                        <h3 style="color: #fff; font-size: 1.1rem; margin: 0; display: flex; align-items: center; gap: 0.5rem;">
                            <i class="fa-solid fa-earth-asia" style="color: #38bdf8; font-size: 1.25rem; filter: drop-shadow(0 0 8px #38bdf8);"></i>
                            <span>แผนที่กำไร-ขาดทุนโลก (Interactive World Profit & Loss Map Dashboard)</span>
                        </h3>
                        <p style="color: var(--text-secondary); font-size: 0.78rem; margin: 0.2rem 0 0;">
                            สีเขียว = ประเทศทำกำไร (Winners) | สีแดง = ประเทศขาดทุน (Loss & Drain) | ตัวกรองด้านบนและปุ่มด้านล่างจะเปลี่ยนสีแผนที่ทันที
                        </p>
                    </div>
                    <div style="display: flex; gap: 0.5rem; align-items: center; flex-wrap: wrap;">
                        <button class="btn btn-sm" id="mapBtnAll" onclick="setMapFilter('all')" style="background: rgba(56,189,248,0.3); color: #fff; border: 1px solid #38bdf8; font-weight: 700;">🌐 แสดงทั้งหมด (All)</button>
                        <button class="btn btn-sm" id="mapBtnWin" onclick="setMapFilter('win')" style="background: rgba(16,185,129,0.1); color: var(--emerald-light); border: 1px solid rgba(16,185,129,0.4);">🟢 เฉพาะทำกำไร (Profit)</button>
                        <button class="btn btn-sm" id="mapBtnLoss" onclick="setMapFilter('loss')" style="background: rgba(244,63,94,0.1); color: #fda4af; border: 1px solid rgba(244,63,94,0.4);">🔴 เฉพาะขาดทุน (Loss)</button>
                    </div>
                </div>

                <div class="grid-2" style="grid-template-columns: 1.5fr 1fr; gap: 1.25rem; align-items: start;">
                    <!-- Map Container -->
                    <div style="background: #090e17; border: 1px solid rgba(255,255,255,0.08); border-radius: 10px; padding: 0.75rem; position: relative; min-height: 380px; display: flex; flex-direction: column; justify-content: center; align-items: center;">
                        <div id="worldMapChart" style="width: 100%; height: 360px;"></div>
                        <div id="mapLoading" style="position: absolute; color: #94a3b8; font-size: 0.9rem;"><i class="fa-solid fa-spinner fa-spin" style="color: #38bdf8; font-size: 1.5rem;"></i> กำลังโหลดแผนที่โลก Interactive...</div>
                    </div>

                    <!-- Interactive Country List Panel -->
                    <div style="background: rgba(0,0,0,0.35); border: 1px solid rgba(255,255,255,0.08); border-radius: 10px; padding: 0.85rem; height: 380px; display: flex; flex-direction: column;">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.6rem; border-bottom: 1px solid rgba(255,255,255,0.1); padding-bottom: 0.4rem;">
                            <span style="color: #fff; font-weight: 700; font-size: 0.85rem;"><i class="fa-solid fa-list-ol" style="color: var(--gold-light);"></i> อันดับผลงานรายประเทศ (Filtered Ranking)</span>
                            <span class="badge-pill" id="mapCountBadge" style="background: rgba(255,255,255,0.1); color: #cbd5e1; font-size: 0.7rem;">0 ประเทศ</span>
                        </div>
                        <div style="overflow-y: auto; flex: 1; padding-right: 0.25rem;" id="mapCountryList">
                            <!-- Populated by JS -->
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        // Google Charts GeoChart & Map Dashboard Logic
        let googleMapReady = false;
        let worldGeoChart = null;
        let mapModeFilter = 'all'; // 'all', 'win', 'loss'
        ...
        if (typeof google !== 'undefined' && google.charts) {{
            ...
            google.charts.setOnLoadCallback(() => {{
                ...
                if (currentMode === 'dash') renderWorldMap();
            }});
        }}

        window.addEventListener('resize', () => {{
            if (currentMode === 'dash' && googleMapReady) {{
                renderWorldMap();
            }}
        }});

        function scrollToMap() {{
            if (currentMode !== 'dash') switchMode('dash');
            const mapSec = document.getElementById('globalProfitMapSection');
            if (mapSec) {{
                mapSec.scrollIntoView({{ behavior: 'smooth', block: 'start' }});
                mapSec.style.transition = 'box-shadow 0.5s ease';
                mapSec.style.boxShadow = '0 0 40px rgba(56, 189, 248, 0.6)';
                setTimeout(() => {{ mapSec.style.boxShadow = '0 10px 30px rgba(0,0,0,0.5)'; }}, 1500);
            }}
        }}
        ...
        function setMapFilter(mode) {{
            ...
            const btnWin = document.getElementById('mapBtnWin');
            const btnLoss = document.getElementById('mapBtnLoss');
            if (btnAll) btnAll.style.background = mode === 'all' ? 'rgba(56,189,248,0.3)' : 'rgba(56,189,248,0.1)';
            if (btnWin) btnWin.style.background = mode === 'win' ? 'rgba(16,185,129,0.3)' : 'rgba(16,185,129,0.1)';
            if (btnLoss) btnLoss.style.background = mode === 'loss' ? 'rgba(244,63,94,0.3)' : 'rgba(244,63,94,0.1)';
            renderWorldMap();
        }}
        ...
        function renderWorldMap() {{
            ...
            // Filter RAW_DATA.country based on marketVal and mapModeFilter and quickMode
            let ctryData = RAW_DATA.country.filter(r => marketVal === 'all' || r['Market'] === marketVal);
            if (quickMode === 'winners' || mapModeFilter === 'win') ctryData = ctryData.filter(r => r['Profit'] > 0);
            if (quickMode === 'disc' || quickMode === 'drain' || mapModeFilter === 'loss') ctryData = ctryData.filter(r => r['Profit'] < 0);

            // Sort by profit descending for list
            ctryData.sort((a,b) => b['Profit'] - a['Profit']);

            // Update Country Ranking List Panel
            const listContainer = document.getElementById('mapCountryList');
            const badgeEl = document.getElementById('mapCountBadge');
            if (badgeEl) badgeEl.innerText = `${{ctryData.length}} ประเทศ`;

            if (listContainer) {{
                let listHtml = '';
                if (ctryData.length === 0) {{
                    listHtml = '<div style="color: #64748b; text-align: center; padding: 2rem;">ไม่พบข้อมูลประเทศตามเงื่อนไข</div>';
                }} else {{
                    ctryData.forEach((c, idx) => {{
                        const isWin = c['Profit'] >= 0;
                        const pStr = isWin ? `+$${{(c['Profit']/1000).toFixed(1)}}K` : `-$${{(Math.abs(c['Profit'])/1000).toFixed(1)}}K`;
                        const color = isWin ? '#10b981' : '#f43f5e';
                        const bgColor = isWin ? 'rgba(16,185,129,0.08)' : 'rgba(244,63,94,0.08)';
                        const borderCol = isWin ? 'rgba(16,185,129,0.3)' : 'rgba(244,63,94,0.3)';
                        const icon = isWin ? '🏆' : '🚨';

                        listHtml += `
                            <div style="display: flex; justify-content: space-between; align-items: center; background: ${{bgColor}}; border: 1px solid ${{borderCol}}; border-radius: 6px; padding: 0.55rem 0.75rem; margin-bottom: 0.45rem; font-size: 0.78rem;">
                                <div style="display: flex; align-items: center; gap: 0.5rem; overflow: hidden;">
                                    <span style="color: #94a3b8; font-weight: 700; width: 22px; flex-shrink: 0;">#${{idx+1}}</span>
                                    <span style="color: #fff; font-weight: 700; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">${{icon}} ${{c['Country']}}</span>
                                    <span style="color: #64748b; font-size: 0.7rem; flex-shrink: 0;">(${{c['Market']}})</span>
                                </div>
                                <div style="text-align: right; flex-shrink: 0; margin-left: 0.5rem;">
                                    <div style="color: ${{color}}; font-weight: 800; font-size: 0.82rem;">${{pStr}}</div>
                                    <div style="color: #94a3b8; font-size: 0.68rem;">Margin: ${{c['Margin']}}%</div>
                                </div>
                            </div>
                        `;
                    }});
            ...
            // Draw Google GeoChart if ready
            if (googleMapReady && typeof google !== 'undefined' && google.visualization) {{
                const mapEl = document.getElementById('worldMapChart');
                if (!mapEl) return;

                let chartData = [['Country', 'Profit ($)', 'Sales ($)', 'Margin (%)']];
                ctryData.forEach(c => {{
                    chartData.push([c['Country'], Math.round(c['Profit']), Math.round(c['Sales']), c['Margin']]);
                }});

                if (chartData.length === 1) {{
                    chartData.push(['United States', 0, 0, 0]); // dummy to prevent crash if empty
                }}

                var data = google.visualization.arrayToDataTable(chartData);

                let minVal = Math.min(...ctryData.map(c => c['Profit']), -10000);
                let maxVal = Math.max(...ctryData.map(c => c['Profit']), 10000);

                var options = {{
                    colorAxis: {{
                        colors: ['#e11d48', '#fb7185', '#334155', '#34d399', '#059669'],
                        values: [minVal, -5000, 0, 5000, maxVal]
                    }},
                    backgroundColor: '#090e17',
                    datalessRegionColor: '#1e293b',
                    defaultColor: '#334155',
                    legend: {{
                        textStyle: {{color: '#cbd5e1', fontName: 'Inter', fontSize: 11}},
                        numberFormat: '$#,###'
                    }},
                    tooltip: {{
                ...
                if (!worldGeoChart) {{
                    worldGeoChart = new google.visualization.GeoChart(mapEl);
                }}
                worldGeoChart.draw(data, options);
            }}
        }}
