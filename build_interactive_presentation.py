                ...
                <div class="grid-3" style="row-gap: 1.5rem;">
                    ...
                    <div class="card" style="border-top: 4px solid var(--gold); padding: 1.25rem;">
                        ...
                        <div style="background: rgba(244, 63, 94, 0.1); padding: 0.5rem; border-radius: 8px; font-size: 0.75rem;">
                            <span style="color: #fda4af; font-weight: 700;">🛑 หลุมดำ:</span> <strong>ขาดทุนเรื้อรัง 29 ประเทศ รวม -$447,000!</strong> นำโดย <strong>Turkey (-$98K)</strong>, <strong>Nigeria (-$80K)</strong>, <strong>Netherlands (-$41K)</strong>
                        </div>
                    </div>
